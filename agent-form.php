...
<div class="property-form-wrap agent-form-modern">
  <div class="property-form clearfix form-container">
    <form method="post" action="#">
      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="form-group">
            <input class="form-control" name="name" value="<?php echo esc_attr($user_name); ?>" type="text" placeholder=" ">
            <label class="floating-label"><?php echo houzez_option('spl_con_name', 'Name'); ?></label>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class="col-12">
          <div class="form-group form-multi-group">
            <select name="country_code_bottom_unique" class="form-control" style="max-width: 120px;">
        ...
        <input name="mobile_number_bottom_unique" class="form-control" placeholder=" " autocomplete="off">
        <label class="floating-label" style="left: 140px;"><?php echo houzez_option('spl_con_phone', 'Phone'); ?></label>
      ...
      <div class="col-12">
        <div class="form-group">
          <input class="form-control" name="email" value="<?php echo esc_attr($user_email); ?>" type="email" placeholder=" " autocomplete="off">
          <label class="floating-label"><?php echo houzez_option('spl_con_email', 'Email'); ?></label>
        </div>
      </div>
      <?php endif; ?>
      ...
      <div class="col-12">
        <div class="form-group">
          <textarea class="form-control hz-form-message" name="message" rows="4" placeholder=" " autocomplete="off"><?php echo houzez_option('spl_con_interested', "Hello, I am interested in"); ?> [<?php echo get_the_title(); ?>]</textarea>
          <label class="floating-label"><?php echo houzez_option('spl_con_message', 'Message'); ?></label>
        </div>
      </div>
      <?php endif; ?>
